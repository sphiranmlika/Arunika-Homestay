...
<body>
    <div class="navbar">
        <h1>
            <img src="logo.png" alt="Logo Arunika Homestay">Arunika Homestay
        </h1>
        <a href="Tampilan.php" class="login-btn">Login</a>
    </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="card h-100">
                    <img src="kamar1.jpg" class="card-img-top" alt="The Kipling">
                    <div class="card-body">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="card h-100">
                    <img src="kamar2.jpg" class="card-img-top" alt="The Shakespeare">
                    <div class="card-body">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="card h-100">
                    <img src="kamar3.jpg" class="card-img-top" alt="The Joyce">
                    <div class="card-body">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="card h-100">
                    <img src="kamar4.jpg" class="card-img-top" alt="The Milton">
                    <div class="card-body">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="card h-100">
                    <img src="kamar5.jpg" class="card-img-top" alt="The Lewis">
                    <div class="card-body">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="card h-100">
                    <img src="kamar6.jpg" class="card-img-top" alt="The Byron">
                    <div class="card-body">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="card h-100">
                    <img src="kamar8.jpg" class="card-img-top" alt="The Shaw">
                    <div class="card-body">
