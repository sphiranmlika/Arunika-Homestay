...
<body>
    <div class="container">
        ...
        <div class="img-container" id="mediaContainer">
            <img src="kamar8.jpg" alt="Kost Zeal 2 Residence Alam Sutera Serpong">
        </div>
        <div class="info">
            <ul>
                <li id="showPhotos">
                    <img class="icon" src="path_to_photo_icon.png" alt="Foto">
                    <span>foto</span>
                </li>
                <li id="showVideo">
                    <img class="icon" src="path_to_video_icon.png" alt="Video">
                    <span>Video</span>
                </li>
                <li>
                    <img class="icon" src="path_to_360_icon.png" alt="360°">
                    <span>360°</span>
                </li>
            </ul>
            <p><span>KosɅndalan</span></p>
            <p><span>Kost Zeal 2 Residence Alam Sutera Serpong</span>, Utara Tangerang Selatan 392ZR</p>
            <p><span>Kos Campur</span>, KecSerpong Utara</p>
